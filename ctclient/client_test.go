...
func TestReadResponseBody(t *testing.T) {
	// under the limit
	if body, err := readResponseBody(strings.NewReader("hello"), 10); err != nil {
	...
	if body, err := readResponseBody(strings.NewReader("0123456789"), 10); err != nil {
	...
	if _, err := readResponseBody(strings.NewReader("0123456789X"), 10); err == nil {
